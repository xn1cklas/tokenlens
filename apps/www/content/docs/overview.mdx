...
- The **catalog** to load (`"auto"`, `"openrouter"`, `"models.dev"`, `"vercel"`, or a custom `SourceProviders` object).
...
- `"auto"` – smart selection backed by the Tokenlens catalog service.
