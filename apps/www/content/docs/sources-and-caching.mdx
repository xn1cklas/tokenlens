---
title: "Sources & Caching"
description: "How sources and loaders work in Tokenlens and how to configure caching."
---
...
| `"vercel"`     | Live catalog from Vercel AI Gateway    | Fetches over HTTP and normalizes OpenAI-compatible responses.   |
