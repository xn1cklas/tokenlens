...
export const models: Readonly<Record<ModelId, Model>> = Object.freeze(
  Object.fromEntries(all.map((m) => [m.id, m as Model])) as Record<ModelId, Model>
);
 ...
 */
export const aliases: Readonly<Record<string, string>> = Object.freeze(Object.fromEntries(aliasMap));
 ...
 */
export function listModels(filter?: { provider?: Provider; status?: Status }): Model[] {
